...
QT_TRANSLATE_NOOP("retrex-core", "(22011 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("retrex-core", "(default: %s)"),
QT_TRANSLATE_NOOP("retrex-core", "(default: 1)"),
QT_TRANSLATE_NOOP("retrex-core", "(must be 22011 for mainnet)"),
...
QT_TRANSLATE_NOOP("retrex-core", "Copyright (C) 2018 The Retrex Core Developers"),
