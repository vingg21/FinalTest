...
std::list<std::string> ZReexControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZReexControlDialog::listMints;
...
void ZReexControlDialog::updateLabels()
{
    ...
    privacyDialog->setZReexControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZReexControlDialog::GetSelectedMints()
{
